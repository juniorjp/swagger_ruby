...
module SwaggerClient
  ...
  class MarketChange
    ...
    attr_accessor :market_definition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rc')
        if (value = attributes[:'rc']).is_a?(Array)
          self.rc = value
        end
      end
      ...
      if attributes.has_key?(:'con')
        self.con = attributes[:'con']
      end

      if attributes.has_key?(:'marketDefinition')
        self.market_definition = attributes[:'marketDefinition']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tv == o.tv &&
          con == o.con &&
          market_definition == o.market_definition &&
          id == o.id
    end
    ...
    def hash
      [rc, img, tv, con, market_definition, id].hash
    end
